  ...
  <div class="hello">
    ...
    <div id="content">
      <div class="introduction">
        ...
        <div class="detail">
          <p>
            <a-icon type="heart" theme="twoTone" two-tone-color="#08c"/>
            <span>VLPR是现代智能交通系统的核心基础技术之一，能够被广泛的应用于道路交通监控、停车场管理、高速收费管理中，节省了大量的人力和物力资源。</span>
          </p>
          <p>
            <a-icon type="heart" theme="twoTone" two-tone-color="#08c"/>
            <span>本作品主要对车牌识别系统所涉及的车牌定位、车牌分割和车牌识别三个必要环节展开研究与模型训练，并利用OpenCV + SpringBoot + Vue技术开发出的一套车牌识别系统。</span>
          </p>
        </div>
      </div>
      <div class="advantage">
        <div class="introduction">
          ...
          <div class="detail">
            <p>
              <a-icon type="star" theme="twoTone" two-tone-color="#08c" />
              <span>以SpringBoot+Vue为载体实现与用户的交互，功能性极简主义的UI设计风格，增强用户体验。</span>
            </p>
            <p>
              <a-icon type="star" theme="twoTone" two-tone-color="#08c" />
              <span>B/S架构便于后期维护和版本升级，安全架设和集中优化明确且便利。</span>
            </p>
            <p>
              <a-icon type="star" theme="twoTone" two-tone-color="#08c" />
              <span>基于svm算法的车牌检测训练、以及基于ann算法的车牌号码识别训练，主要包含黄、蓝、绿车牌检测及车牌号码识别，可对单张照片，单图片多车牌进行检测及识别。</span>
            </p>
          </div>
        </div>
      </div>
